# Project Rules — biz-pm-pricing-tool

ไฟล์ `.xlsx` สร้างจาก `build_pm_pricing_tool.py` (openpyxl) — **แก้ที่สคริปต์แล้ว
re-generate เสมอ ห้ามแก้ในไฟล์ Excel ตรงๆ**
เครื่องมือนี้ป้อนราคาให้ชีต `F_SERVICE` ของ repo `biz-roi-laundromat` แก้ราคาที่นี่แล้วต้องตามไปปรับที่นั่น
